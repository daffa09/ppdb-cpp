		...
		login:
			...
			menus:
				...
				if (choose == 1)
				{
					...
					cout << "Kembali Ke Menu Hak Admin? [y/n] : ";
					cin >> re;
					if (re == 'Y' || re == 'y')
					{
						goto menus;
...
void kontak()
{
	...
	system("cls");
	cout << "\n\n=========Kontak============" << endl;
	cout << "daffa = +6520000000" << endl;
	cout << "Instagram = dafathan.v2" << endl;
...
void kompetensi()
{
	...
	cout << endl;
	cout << "=> Administrasi Perkantoran" << endl;
	cout << "\tAP akan belajar menjadi sekretaris yang" << endl;
...
void addDataSiswa()
{
	...
	cout << endl
			 << endl;
	cout << "\nJumlah siswa yang ingin di daftarkan :  ";
	cin >> b;
	cin.ignore(numeric_limits<streamsize>::max(), '\n');
	d = 0;
...
void updateDataSiswa()
{
	...
	cout << "Masukan No urut yang akan di edit : ";
	cin >> k;
	cin.ignore(numeric_limits<streamsize>::max(), '\n');
	l = k - 1;
